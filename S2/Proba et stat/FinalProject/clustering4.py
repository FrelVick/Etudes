...
def info_based_clustering(s_matrix, n_item, n_cluster, t, e):
    ...
    while True:
        ...
        ## p(m+1)(C|i)
        ## 1er point
        p_next_clusters_for_items = np.multiply(p_clusters, np.exp(
            (1 / t) * ((2 * items_similarity_to_clusters) - similarity_in_clusters)))
...
def question3(f, t, e):
    ...
    verification(items, clusters, estimated_partition, "./sp500_data_id/sp500_names.d",
                 "./sp500_data_id/sp500_matType.d", "./sp500_data_id/sp500_TypeNames.d")
...
def question4(f, t, e):
    ...
    verification(items, clusters, estimated_partition, "D:\Учеба\Master\Etudes\S2\Proba et stat\FinalProject\movie_data_id\mi_movie.d",
                 "D:\Учеба\Master\Etudes\S2\Proba et stat\FinalProject\movie_data_id\movie_labels.d",
                 "D:\Учеба\Master\Etudes\S2\Proba et stat\FinalProject\movie_data_id\movie_typename")
